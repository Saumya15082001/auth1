defmodule Auth1Web.UserConfirmationControllerTest do
  ...
  describe "GET /users1/confirm" do
  ...
  describe "POST /users1/confirm" do
    @tag :capture_log
  ...
  describe "GET /users1/confirm/:token" do
  ...
  describe "POST /users1/confirm/:token" do
